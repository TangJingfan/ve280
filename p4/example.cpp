...
int main() {
  ...
  cout << "First card in new deck: " << SpotNames[before.spot] << " of "
       << SuitNames[before.suit] << endl;
  cout << "Second card in shuffled deck: " << SpotNames[after.spot] << " of "
       << SuitNames[after.suit] << endl;
